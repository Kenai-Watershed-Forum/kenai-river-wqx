...
expense_dat <- read_excel("other/input/financial/Agency Baseline_expenses_timeline.xlsx",
...
embed_file("other/output/financial/expense_dat.csv", text = "Download Kenai River Baseline Water Quality Monitoring Project expense history 2005 - 2022")
```
...
z <- expense_dat %>%
  ...
  # assign major or minor expense categories
  mutate(expense_category = case_when(
    expense %in% c("Contractual Expense","Personnel","Supplies", "Indirect Cost Expense")  ~ "major",
    TRUE ~ "other"))
