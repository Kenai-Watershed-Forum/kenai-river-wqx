...
# to do: clean up this qmd document
# - include just boxplot stuff, do data read in and pre-processing in a different doc
# - ref to data absence epa hows my waterway, in progress fix
# - ref to total extent of data in epa wqx
# confirm outlier removal works, org to prep to eqp wqx sync
...
# make corrections where known errors exist from wqx import
...
```{r echo = F, warning=FALSE, message=FALSE}
# write finalized data that will be used for graphing and analysis to external location 
# this export format represents the most granular presentation, nothing has been aggregated. The "reg_limits.qmd" script aggregates volatiles, for example
write.csv(dat,"other/output/analysis_format/baseline_export_format.csv",row.names = F)

z <- read.csv("other/output/analysis_format/baseline_export_format.csv")
