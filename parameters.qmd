...
### Calculate temporal extent of time series by site/season/parameter
...
# focus on creating this boxplot as a template before replicating for all other parameters
# include adec reg limits
...
dat %>%
  ...
  facet_grid(.~season) +
  geom_boxplot() +
  ggtitle(paste(parameter,"2000-2014,","Kenai River Tributaries"))
