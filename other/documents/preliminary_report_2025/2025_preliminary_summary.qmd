...
# The full setup chunk (libraries, paths, data loading) runs later in the document.
report_year <- 2025
```
...
# ---- Year configuration (change this for each new field season) -------------
report_year <- 2025
...
The Kenai Watershed Forum (KWF) has conducted baseline water quality monitoring on the Kenai River and its major tributaries since 2000. More information about the project and access to data and reports are available at the links below.
...
tibble(
  ...
  Notes       = c(
    "Metals and nutrients; TSS and FC at 6 mainstem sites",
    "Metals, nutrients, and hydrocarbons (BTEX); TSS and FC at mainstem sites"
  )
) |>
