...
-   The [Kenai River Baseline Water Quality Monitoring project](https://www.kenaiwatershed.org/kenai-river-baseline-water-quality-monitoring/)[^finance_history-1] is funded both direct as well as in-kind financial support from project partners.
...
```{r echo = F, message = F,warning = F, fig.height=6, fig.width=16}
#| label: fig-income-c
