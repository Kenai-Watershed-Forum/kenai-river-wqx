...
-   While project support has remained mostly steady, inflation of the U.S. dollar since 2005 (56%) has reduced the value of resources available to the project since 2005.

-   **In order to continue Kenai River water quality monitoring efforts, the project must sustain necessary funding levels.**

-   **Read the Project Partner Update Letter Here**
...
embed_file("other/documents/financial/2024 Kenai River Water Quality Monitoring MOU Signature Request Letter.docx", text = "Download Kenai River Water Quality Monitoring Project Partner Request Letter (Draft)")
```

*\[Draft; writing In Progress 10/28/2024. This will summarise information about both the incoming Memorandum of Understanding renewal and financial needs\]*
...
Adjusted for inflation, project income has seen a steady decline from 2005 - 2022. @fig-inf-adj-inc displays inflation adjusted project income history.
...
Project income history fluctuates annually as partner contributions vary. @fig-income-a displays annual cash contributions by individual partner organizations. Most partner organizations have continued to contribute a constant annual amount once the original agreement was established.
...
```{r}
#| label: fig-income-d
#| fig-cap: "Total annual project income, adjusted for inflation relative from 2005 - 2023. Accounting for inflation, year 2023 annual project income is 31% lower (~$6,619 less) than year 2005."
...
-   As of November 2024, a projected income gap of \$20,045.84 exists
