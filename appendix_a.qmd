...
xfun::embed_file('other/input/2021_wqx_data/spring_2021_wqx_data/SGS/spring_2021_sgs_batch_info.csv', text = "Download Original Spring 2021 Metals/Nutrients Lab Results from SGS - Electronic Data Delivery file")

xfun::embed_file('other/input/2021_wqx_data/spring_2021_wqx_data/SGS/Spring 2021 Results from SGS.pdf', text = "Download Original Spring 2021 Metals/Nutrients Lab Results from SGS - PDF file")

```

```{r, echo = F}
xfun::embed_file('other/input/2021_wqx_data/summer_2021_wqx_data/SGS/summer_2021_sgs_batch_info.csv', text = "Download Original Summer 2021 Metals/Nutrients Lab Results from SGS - Electronic Data Delivery file")

xfun::embed_file('other/input/2021_wqx_data/summer_2021_wqx_data/SGS/SGS_results_Summer2021.pdf', text = "Download Original Summer 2021 Metals/Nutrients Lab Results from SGS - PDF file")
...
write.csv(dat,"other/output/wqx_formatted/2021_kwf_baseline_results_wqx.csv",row.names = F)
...
```{r, echo = F}
xfun::embed_file('other/output/wqx_formatted/2021_kwf_baseline_results_wqx.csv', text = "Download All Provisional 2021 Kenai River Baseline Water Quality Monitoring Results, Formatted for EPA WQX import")


# check unique activity types
#z <- read.csv("other/output/wqx_formatted/2021_kwf_baseline_results_wqx.csv")
...
```{r, echo = F}
xfun::embed_file('other/documents/wqx_documents/Kenai_Baseline_Data_Evaluation_Checklist_20230331.xlsx', text = "Download 2021 Draft Kenai Baseline Data Evaluation Checklist Template")
...
total_samples_collected_2021_summary_param <- read.csv('other/output/wqx_formatted/2021_kwf_baseline_results_wqx.csv') %>%
  clean_names() %>%
...
total_samples_collected_2021_summary <- read.csv('other/output/wqx_formatted/2021_kwf_baseline_results_wqx.csv') %>%
  clean_names() %>%
...
# embed for download
xfun::embed_file("other/input/wqx_templates/sample_holding_times.csv", text = "Download Table of Maximum Holding Times for Each Sample Type")
```
...
export_dat <- read.csv('other/output/wqx_formatted/2021_kwf_baseline_results_wqx.csv') %>%
  clean_names()
...
xfun::embed_file("other/output/field_qa_qc_data/rpd_check_dat.csv", text = "Download 2021 Duplicate Sample Relative Percent Difference Data")
...
```{r echo = F}
# export csv of rpd results 
xfun::embed_file("other/documents/QAPP/memos/KWF Memo to ADEC August 2023.pdf", text = "Download August 2023 Memo to ADEC regarding RPD Interpretation")
...
# embed for download
xfun::embed_file("other/output/lab_qaqc_data/matrix_spike_recovery_fails_2021.csv", text = "Download Matrix Spike Recovery Values Exceeding Threshold for 2021 Sample Analyses")
...
write.csv(export_dat, "other/output/wqx_formatted/2021_export_data_flagged.csv", row.names = F)
...
completeness_summary_param <- read.csv('other/output/wqx_formatted/2021_export_data_flagged.csv') %>%
  clean_names() %>%
...
completeness_summary_site <- read.csv('other/output/wqx_formatted/2021_export_data_flagged.csv') %>%
  clean_names() %>%
  # reduce the list of analytes to only those specified in QAPP
  left_join(analytes_2021) %>%
  filter(param_in_qapp == "Y") %>%
...
completeness_summary_project <- read.csv('other/output/wqx_formatted/2021_export_data_flagged.csv') %>%
  clean_names() %>%
  # reduce the list of analytes to only those specified in QAPP
  left_join(analytes_2021) %>%
  filter(param_in_qapp == "Y") %>%
...
# embed for download
xfun::embed_file("other/output/field_qa_qc_data/completeness_measures/cma_parameter.csv", text = "Download Completeness Measure A Results, By Parameter")
xfun::embed_file("other/output/field_qa_qc_data/completeness_measures/cma_site.csv", text = "Download Completeness Measure A Results, By Site")
xfun::embed_file("other/output/field_qa_qc_data/completeness_measures/cma_project.csv", text = "Download Completeness Measure A Results, By Overall")
...
cmb_by_method <- read.csv('other/output/wqx_formatted/2021_export_data_flagged.csv') %>%
  clean_names() %>%
  # reduce the list of analytes to only those specified in QAPP
  left_join(analytes_2021) %>%
  filter(param_in_qapp == "Y") %>%
...
cmb_by_site <- read.csv('other/output/wqx_formatted/2021_export_data_flagged.csv') %>%
  clean_names() %>%
  # reduce the list of analytes to only those specified in QAPP
  left_join(analytes_2021) %>%
  filter(param_in_qapp == "Y") %>%
...
cmb_project <- read.csv('other/output/wqx_formatted/2021_export_data_flagged.csv') %>%
  clean_names() %>%
  left_join(analytes_2021) %>%
  filter(param_in_qapp == "Y") %>%
  group_by(flag) %>%
...
```{r echo = F, message=FALSE}
xfun::embed_file("other/output/field_qa_qc_data/completeness_measures/cmb_parameter.csv", text = "Download Completeness Measure B Results, By Parameter")
xfun::embed_file("other/output/field_qa_qc_data/completeness_measures/cmb_site.csv", text = "Download Completeness Measure B Results, By Site")
xfun::embed_file("other/output/field_qa_qc_data/completeness_measures/cmb_project.csv", text = "Download Completeness Measure B Results, Overall")
```
...
export_dat <- read.csv("other/output/wqx_formatted/2021_export_data_flagged.csv")
...
# re-write export_dat
write.csv(export_dat,"other/output/wqx_formatted/2021_export_data_flagged.csv")
...
```{r echo = F}
# embed for download
xfun::embed_file(dir, text = "Download Observation Count by Characteristic, 2021 Kenai River Baseline Water Quality")
```
...
# NOTE: The project and station assembly steps below are commented out here
# but are a CRITICAL part of each annual CDX submission. For each new year,
# the project CSV (with QAPP status and website) and station CSV (KWF sites only)
# must be assembled and included alongside the results/activities export.
# These steps should be integrated into the annual submission pipeline
# in the kenai-river-wqx-qaqc repo when that pipeline is built out.

# project
#project <- read.csv("other/input/WQX_downloads/project/project.csv")
#write.csv(project,"other/output/wqx_formatted/project.csv", row.names = F)

# stations (filter to KWF sites only)
#station <- read.csv("other/input/WQX_downloads/station/station.csv") %>%
#  filter(grepl("KBL", MonitoringLocationName))
#write.csv(station,"other/output/wqx_formatted/station.csv", row.names = F)
```
