...
submitted_dat <- read.csv("other/output/aqwms_formatted_results/final_preparation/results_activities.csv", check.names = F) 
...
write.csv(submitted_dat,"other/output/aqwms_formatted_results/final_preparation/results_activities.csv", row.names = F)
  

# working in this chunk
# task: i need to prep a v2 of "submitted_dat" that includes the 2021 updates. a) corrected ca/mg assignments and b) corrected units. but, in the same format
```
