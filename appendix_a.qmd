...
To see a table comparing planned vs actual results for 2021, view the csv file linked above.
...
***Cause 2:*** For Summer 2021, the SGS laboratory performed the 200.8 analyses for all 27 analytes available for the method; instead of just the smaller subset of analytes as requested. (E.g., KWF received extra data for free. In this case., there are no consequences of deviating from the planned analyses).
...
# check 2016 report to see hwo this was executed exactly .... seems like a ton of data lost
...
Given that 3 out of 4 RPD values for fecal coliform values are >60% (project goal is 20%), field data values for this dataset generally may be suspect.  As a result KWF does not plan to submit 2021 fecal coliform data to the EPA WQX as of `r sys.Date()`.
...
# based on above description, use case_when logic to apply flag Y/N as appropriate. remain agnostic of parameter and year
