...
# Appendix: Data Review and Upload
...
# 12/19/23
# 1st attempt to upload station.csv riddled with errors.
# 1.) claims that MonitoringLocationIDs do not already exist in system. Double check.
...
For this export, we removed all observations that had been "flagged" throughout the QA/QC process described above. Flagged observations will not be uploaded to the EPA WQX.
