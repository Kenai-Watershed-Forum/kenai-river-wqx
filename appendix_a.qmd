...
-   Results:
    ...
    -   **Calcium:** All 12 summer 2021 sites with paired dissolved and total measurements show dissolved \> total. The dissolved Ca concentration exceeds total Ca by 12.7% to 19.0% (median \~18%) across all sites. This is a systematic, consistent pattern that is too large and too uniform to be attributable to measurement uncertainty alone.

    -   **Iron:** All 6 summer 2021 sites with paired data show dissolved \< total, which is the expected relationship. Iron behaves as anticipated.

    -   **Magnesium:** 10 of 13 summer 2021 sites show total \> dissolved, as expected. Two sites near the Kenai River mouth are exceptions: RM 0 NNC (dissolved exceeds total by \~1.2%) and RM 1.5 (dissolved exceeds total by \~2.5%). These small percentage differences are likely within the typical analytical uncertainty for ICP methods (\~5–10%) and may not represent a meaningful discrepancy. Note that the Mg concentration at RM 1.5 is anomalously high (\~68 mg/L, compared to 1–8 mg/L at other lower-river sites), possibly reflecting brackish/tidal influence near Cook Inlet.
...
The calcium discrepancy is unresolved. Dissolved Ca consistently exceeds total Ca by approximately 13–19% at all 12 paired summer 2021 sites. This pattern is too systematic and too large (1.5–5.4 mg/L absolute difference) to be explained by measurement uncertainty alone.
...
The magnesium exceptions at RM 0 NNC (+1.2%) and RM 1.5 (+2.5%) are small enough to fall within typical ICP analytical uncertainty and are not considered significant anomalies. Iron behaves as expected at all sites.
