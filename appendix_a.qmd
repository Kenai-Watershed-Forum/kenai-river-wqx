...
**Are the correct monitoring locations associated with the project?**

```{r echo = F, message=FALSE}

site_check <- export_dat %>%
  distinct(monitoring_location_id,activity_latitude,activity_longitude) %>%
  transform(activity_longitude = as.numeric(activity_longitude))
