...
# [NOTE 10/5/2023 IS THIS ABOVE STATEMENT TRUE???]
...
We found that the project file listed the QAPP (Quality Assurance Project Plan) as "not yet approved." It is possible that this designation is listed as such because previously approved versions of the QAPP (versions 1.0 and 2.0) do not include signatures from an EPA staff on the Title & Approval page, but were instead approved by Alaska Department of Environment Conservation Staff. For the [QAPP approved on 5/9/2023](https://www.kenaiwatershed.org/news-media/qapp-revisions-completed-2023/) (version 3.0), two EPA staff signed as approvers on the Title & Approval page.
...
write.csv(project,"other/output/aqwms_formatted_results/station.csv", row.names = F)
```
