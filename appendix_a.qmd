...
The project-level CMB for 2021 is **52.2%** (282 usable results out of 540 planned), which is below the QAPP goal of 60%. The three primary drivers of the below-goal CMB are:

1.  **Dissolved metals (EPA Method 200.8) — 0% CMB, both seasons.** All results were at or below the LOQ at both primary and duplicate sites, so RPD calculations could not be performed and all results were designated Rejected.

2.  **Fecal coliform (EPA Method 9222D) — 0% CMB, both seasons.** RPD values exceeded the 20% threshold for 3 of 4 duplicate pairs, and all 2021 fecal coliform results were designated Rejected.

3.  **Spring 2021 Total Nitrate/Nitrite-N (SM 4500-NO3(F)) — 0% CMB.** Matrix spike recovery exceedances in the spring 2021 SGS lab report led to all spring nitrate results being designated Rejected. No exceedances were observed in summer 2021, which achieved 100% CMB.

Parameters achieving 100% CMB include: total metals (EPA Method 200.7, summer only — spring was affected by the chain-of-custody error described in Q1), TSS (SM 2540-D), Total Phosphorus (SM 4500-P-E), summer nitrate/nitrite, and BTEX (EPA Method 8260D, summer only). Spring 2021 total metals achieved 59.1% CMB, reflecting the reduced site coverage resulting from the spring 2021 chain-of-custody error.
