...
-   Dissolved metals results are *not* consistently less than total metals results, as would be anticipated (see [Flowlink](https://www.flowlink.ca/post/2018/12/15/dissolved-total-metals-whats-the-difference-and-why-it-matters) website for rationale.)
...
Given that 3 out of 4 RPD values for fecal coliform values are >60% (project goal is 20%), field data values for this dataset generally may be suspect. 

TO DO: Calculate RPD values for 2014-2022 and compare, also compare to RPD values in previous comprehensive report.
