...
(might need to make this question later in sequence)

-   In 2021, there are values available for both dissolved and total metals for three elements: Ca, Fe, and Mg; for sites at and downstream of RM 31. 

(spring only)

cases when total < diss ... why ... ..download below
