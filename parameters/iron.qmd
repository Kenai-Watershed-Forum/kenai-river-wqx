...
# Render plots directly in chunk — htmlwidgets must be output from direct chunk code in Quarto; printing inside source() is not captured for widget output.
