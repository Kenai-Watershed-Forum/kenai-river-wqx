...
datz <- inner_join(dat,hard,by = c("activity_identifier","activity_start_date","result_measure_measure_unit_code","monitoring_location_name")) 




## WORKING HERE. current output here matches hardness for only SOME parameters rather than all. Diagnosing here 10/31/2024
