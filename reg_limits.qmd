...
```{r}
# join static regulatory values to parameter results, and identify where exceedences occur
...
Download sheet of all static threshold calculations for metals here
...
Download sheet of all calculated threshold values for metals here
