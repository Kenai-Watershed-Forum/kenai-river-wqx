...
# UNKNOWN ISSUE WITH THIS JOIN 2/8/2025. MOST OF THE 2021 HARDNESS VALUES ARE NOT IN THE JOINED DF
...
# 1/15/2025: Consider moving this code chunk to "parameters.qmd". It could be logical to have it there along with the read-in of original data. I think this is the only code chunk in this .qmd that manages the original data; all other code chunks just have to do with the regulatory limits
