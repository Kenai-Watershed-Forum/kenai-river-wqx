...
z <- inner_join(dat, diss_metals_hard_param) %>%
  ...
  mutate(fw_chronic_std = case_when(
    ...
    # lead (identical formula as acute)
...
# note: there is certainly a cleaner way to code this, but for now am just reflecting the formula format as provided in the ADEC manual.
